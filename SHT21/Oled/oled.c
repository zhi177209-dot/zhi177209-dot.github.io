...
//	OLED_ShowChinese(36,0,2);//信
//	OLED_ShowChinese(54,0,3);//息
//	OLED_ShowChinese(72,0,4);//工
//	OLED_ShowChinese(90,0,5);//程
	OLED_ShowChinese(0,0,7);
	OLED_ShowChinese(16,0,8);
	OLED_ShowChinese(16*2,0,9);
	OLED_ShowChinese(0,2,10);
	OLED_ShowChinese(16,2,11);
	OLED_ShowChinese(16*2,2,12);
	
	OLED_ShowChinese(0,4,13);
	OLED_ShowChinese(16,4,14);
	OLED_ShowChinese(16*2,4,15);
//	OLED_ShowString(8,2,"OLED Display",16);
	
//	OLED_ShowString(0,4,"MCU is So Easy !",16);  
//    OLED_ShowString(20,6,"2025/06/06",16);
}
